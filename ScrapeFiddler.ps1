...
[string]$Description,
[Parameter()]
[ValidateSet('CausesCrash','Duel', 'Outdoors','Indoors', 'NoTripmines', 'TooBig', 'Small', 'Medium', 'Large', 'Meme', 'NeverLoads', 'LowGrav', 'Remake', 'Incomplete', 'VanillaStyle', 'UT', 'Quake', 'HL1', 'MissingTextures', 'UniqueMechanic')] 
[string[]]$Labels,
[Parameter()]
